...
function Plans() {
    return (
        <section className="plans py-5">
            ...
            <div className="section-description">مستعد لإعداد مكتبتك؟ اختر مدة الاشتراك التي تناسبك</div>
            <div className="container">
                <div className="row mt-5 pb-5">
                    <div className="back_img col-md-4">
                        <div className="back_img">
                            <img className="plans__img" src={subscription} /></div>
                    </div>
                    ...
                    <div className="form_col col-md-4 align-self-lg-end">
                        <div className="card">
                            <div className="card-body">
                                    ...
                                    <div className="active box1 mt-3">
                                        ...
                                        <div className="clearfix">
                                            <div className=" float-right form-inline form-check form-check-inline">
                                                ...
                                                <label className="form-check-label card-title" for="inlineRadio1">
                                                    <h3 className="pr-1">شهري</h3></label>
                                            </div>
                                            <h3 className="float-left">20ILS <strong>/</strong> شهريا</h3>
                                        </div>
                                ...
                                <a href="#" className="btn btn-block btn-primary">اشترك الان</a>
                            </div>
                        </div>
                    </div>
                </div>
