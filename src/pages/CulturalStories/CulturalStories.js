...
function CulturalStories() {
	return (
		<>
			<section className='page-banner about'>
				<div className='page-banner__content'>
					<h1 className='page-banner__title'>قصص حضارية</h1>
					<p className='page-banner__description'>شاهد الآلاف من القصص التاريخية التي تتحدث عن البلدان العربية والبلدات الفلسطينية القديمة بالتحديد</p>
				</div>
			</section>

			<section className='stories-section py-5'>
				<div className='container'>
					<h2 className='section-title section-title--smaller section-title--right mb-4'>القصص الأكثر مشاهدة</h2>
					<div className='row'>
			...
			<section className='stories-section py-5'>
				<div className='container'>
					<h2 className='section-title section-title--smaller section-title--right mb-4'>باقي القصص</h2>
					<div className='row'>
						<div className='col-md-3'>
							<div className='stories-section__container'>
								<div className='stories-section__item'>
